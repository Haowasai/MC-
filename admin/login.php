  ...
  <nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./">FTC工作室-MC云黑后台</a>
      </div><!-- /.navbar-header -->
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          <li class="active">
            <a href="./login.php"><span class="glyphicon glyphicon-user"></span> FTC工作室-MC云黑后台登陆</a>
          </li>
		  <li>
...
if(isset($_POST['user']) && isset($_POST['pass'])){
	...
	exit("<script language='javascript'>alert('欢迎FTC工作室-MC云黑管理员登陆成功！');window.location.href='./';</script>");
}
?>
